namespace gpconnect_user_portal.Helpers.Constants
{
    public class MessageConstants
    {
        ...
        public const string ODSCODEVALIDVALUEERRORMESSAGE = $"{VALIDVALUEERRORMESSAGE} '{DisplayConstants.ODSCODE}'";
        public const string ODSCODEREQUIREDERRORMESSAGE = $"{REQUIREDERRORMESSAGE} '{DisplayConstants.ODSCODE}'";        
        ...
        public const string SELECTEDUSECASEREQUIREDERRORMESSAGE = $"{SELECTVALUEERRORMESSAGE} '{DisplayConstants.USECASE}'";
        public const string USECASEDESCRIPTIONREQUIREDERRORMESSAGE = $"{REQUIREDERRORMESSAGE} '{DisplayConstants.USECASEDESCRIPTION}'";
        public const string SELECTEDCARESETTINGREQUIREDERRORMESSAGE = $"{SELECTVALUEERRORMESSAGE} '{DisplayConstants.CARESETTING}'";
        public const string SELECTEDSUPPLIERREQUIREDERRORMESSAGE = $"{SELECTVALUEERRORMESSAGE} '{DisplayConstants.SUPPLIER}'";
        public const string SELECTEDSUPPLIERPRODUCTUSECASEREQUIREDERRORMESSAGE = $"{REQUIREDERRORMESSAGE} '{DisplayConstants.SELECTEDSUPPLIERPRODUCTUSECASE}'";
