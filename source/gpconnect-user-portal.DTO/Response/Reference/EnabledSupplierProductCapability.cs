...
namespace gpconnect_user_portal.DTO.Response.Reference
{
    public class EnabledSupplierProductCapability
    {
        ...
        public bool IsAppointmentEnabled => SupplierProductCapability.Any(x => x.LookupValue.Contains("Appointment"));
        ...
        public bool IsProviderAssuredForAppointment => SupplierProductCapability.Any(x => x.LookupValue.Contains("Appointment") && x.ProviderAssured);
        public bool IsConsumerAssuredForAppointment => SupplierProductCapability.Any(x => x.LookupValue.Contains("Appointment") && x.ConsumerAssured);
