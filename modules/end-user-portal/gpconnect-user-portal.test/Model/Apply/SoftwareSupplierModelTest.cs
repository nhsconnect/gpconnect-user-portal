...
public class SoftwareSupplierModelTest
{
    ...
    [Fact]
    public async Task OnPost_IfTempDataHasNoData_RedirectsToNextPage()
    {
    ...
    public async Task OnPost_TempDataPopulated_WithExpectedValues()
    {
        ...
        var interactionsList = new List<int>() { 2, 3 };
        ...
        _mockTempDataProviderService.Verify(mtdps => mtdps.PutItem(TempDataConstants.SELECTEDSOFTWARESUPPLIERNAMEID, "1"), Times.Once);
